...
function loginFaceIdReducer(state = {}, action) {
    switch (action.type) {
      case USER_LOGIN_FACEID_SUCCESS:
        return { status: action.payload.status, message: action.payload.message };
      case USER_LOGIN_FACEID_FALL:
        return { error: action.payload };
      default:
        return state;
    }
...
export { loginReducer, loginFaceIdReducer, registerReducer };
